...
SELECT SUM(SALARY) AS SUMSAL , AVG(SALARY) AS AVGSAL, MIN(SALARY) AS MINSAL, MAX(SALARY) AS MAXSAL FROM EMP E, DEPARTMENT D WHERE E.DNO = D.DNO AND D.DNAME = 'ACCOUNT';
